report 1044887 "Transfer Order TW"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'ReportLayout/report1044887.rdlc';
        ...
        dataitem("Transfer Header"; "Transfer Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(YourReference_TransHdr; "Transfer Header"."Your Reference")
                    {
                    }
                    column(YourReferenceText; YourReferenceText)
                    {
                    }
            ...
            begin
                ...
                if "Your Reference" <> '' then
                    YourReferenceText := FieldCaption("Your Reference");
                if "Transfer Header"."Salesperson Code" <> '' then begin
                    if SalesPers.Get("Salesperson Code") then begin
                        SalesPersonText := C_BSS_TXT001;
                        SalesPersonName := SalesPers.Name;
                    end;
                end;
                //--BSS.IT_20050.SG
            end;
    ...
    labels
    {
        ...
        TransferOrderNo_Caption = 'Transfer-Order No.';
    }
    ...
    begin
        ...
        //++BSS.IT_20050.SG
        Evaluate(CurrReportObjectID, DelStr(CurrReport.ObjectId(false), 1, 7));
        //--BSS.IT_20050.SG
    end;
    ...
    begin
        ...
        //++BSS.IT_20050.SG
        if not PrinterLinesResetDone then
            ReleaseTransferDocument.ResetPrinterLine(CurrReportObjectID);
        //--BSS.IT_20050.SG
    end;
    ...
    var
        ...
        _BSS_: Integer;
        YourReferenceText: Text[250];
        SalesPersonText: Text[250];
        SalesPersonName: Text[250];
        C_BSS_TXT001: Label 'Salesperson';
        CurrReportObjectID: Integer;
        ReleaseTransferDocument: Codeunit "Release Transfer Document";
        PrinterLinesResetDone: Boolean;
}
