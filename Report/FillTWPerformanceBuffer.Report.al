report 1044872 "Fill TW Performance Buffer"
{
    // +--------------------------------------------------------------+
        ...
        IF SalesInvoiceLineL.FINDFIRST THEN
            REPEAT
                ...
                InsertSalesInvoiceHeaderBuffer(SalesInvoiceHeaderP, BufferG.FIELDNO("Profit Amt"), CancelRateL *
                    GetDocumentLineProfit(ItemLedEntryG."Document Type"::"Sales Invoice", SalesInvoiceLineL."Document No.", SalesInvoiceLineL."Line No.",
            ...
            LineTypeP::Item:
                CASE DocumentTypeP OF
                    DocumentTypeP::"Sales Invoice":
                        BEGIN
                            ValueEntryG.RESET;
                            ValueEntryG.SETCURRENTKEY("Document No.");
