table 1044872 "Sales Cr.Memo Line Buffer"
{
    Caption = 'Sales Cr.Memo Line Buffer';
    ...
    fields
    {
        ...
        field(1017214; "Credit Memo Rate %"; Decimal)
        {
            Caption = 'Credit Memo Rate %';
            Description = 'IT_1428';
        }
        ...
        field(1018330; "Noise Performance"; Code[3])
        {
            ...
            TableRelation = "Item Additional Attributes".Code;
        }
        ...
        //     ObsoleteState = Removed;
        //     ObsoleteReason = 'Removed as part of Item Category Requirement';
        // }
        ...
        field(1044380; "Additional Sale"; Boolean)
        {
            ...
            DataClassification = ToBeClassified;
            Description = 'IT_23140';
            Editable = false;
        }
        field(1044390; "Sell-to Customer Name"; Text[100])
        {
            CalcFormula = Lookup("Sales Cr.Memo Header Buffer"."Sell-to Customer Name" WHERE("Service Center Key" = field("Service Center Key"), "No." = FIELD("Document No.")));
        ...
        {
            CalcFormula = Lookup("Sales Cr.Memo Header Buffer"."Sell-to Customer Name 2" WHERE("Service Center Key" = field("Service Center Key"), "No." = FIELD("Document No.")));
        ...
        {
            CalcFormula = Lookup("Sales Cr.Memo Header Buffer"."Sell-to Contact" WHERE("Service Center Key" = field("Service Center Key"), "No." = FIELD("Document No.")));
